...
class BreakTheRowPreparationScreen extends StatefulWidget {
  const BreakTheRowPreparationScreen({super.key});

  @override
  State<BreakTheRowPreparationScreen> createState() =>
      _BreakTheRowPreparationScreenState();
}

class _BreakTheRowPreparationScreenState
    extends State<BreakTheRowPreparationScreen> {
  BreakTheRowDifficulty selectedDifficulty = BreakTheRowDifficulty.basic;

  void startGame(BuildContext context) {
    Navigator.of(
      context,
    ).pushNamed(AppRoutes.breakTheRow, arguments: selectedDifficulty);
  }
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Text(
              'Completa líneas horizontales moviendo, rotando y bajando las piezas.',
              style: TextStyle(
            ...
            Container(
              ...
              child: Column(
                children: [
                  const Icon(Icons.grid_view, color: Colors.white, size: 58),
            ...
            const SizedBox(height: 12),
            for (final difficulty in BreakTheRowDifficulty.values) ...[
              _DifficultyOption(
            ...
            Container(
              ...
              child: const Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Regla: tienes 3 vidas. Completa las líneas objetivo del nivel para terminar la sesión.',
                      style: TextStyle(
            ...
            Container(
              ...
              child: const Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Controles: mover izquierda, mover derecha, rotar y bajar rápido.',
                      style: TextStyle(
                        color: AppColors.navy,
                        fontSize: 15,
                        height: 1.4,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 5),
                    Text(
                      'Objetivo: ${config.targetLines} líneas',
                      style: const TextStyle(
